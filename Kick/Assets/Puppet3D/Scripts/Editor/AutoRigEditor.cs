...
namespace Puppet3D
{
	public class AutoRigEditor : Editor
	{
		...
		public static void CreateModRig(bool rigFingers = false)
		{
			...
			ikfk = OffsetIKFK(Chest, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05");
			if (ikfk != null)
			{
				ikfk.ContrstrainPosition = true;
			...
			ikfk = OffsetIKFK(LeftUpperArm, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavL/shoulderL");
			if (ikfk != null)
			{
			...
			ikfk = OffsetIKFK(RightUpperArm, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavR/shoulderR");
			if (ikfk != null)
			{
			...
			ikfk = OffsetIKFK(LeftHand, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavL/shoulderL/elbowL/handL");
			if (ikfk != null)
			{
			...
			ikfk = OffsetIKFK(RightHand, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavR/shoulderR/elbowR/handR");
			if (ikfk != null)
			{
			...
			ikfk = OffsetIKFK(Neck, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/Neck");
			if (ikfk != null)
			{
			...
			ikfk = OffsetIKFK(Head, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/Neck/Head");
			if (ikfk != null)
			{
				//ikfk.Handle = GameObject.Find("Head_CTRL").transform;
				ikfk.GroupID = IKFKBlend.IKFKType.Body;
			...
			ikfk = OffsetIKFK(LeftLowerArm, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavL/shoulderL/elbowL");
			if (ikfk != null)
			{
				ikfk.GroupID = IKFKBlend.IKFKType.ArmL;
				ikfk.Init();
			}
			ikfk = OffsetIKFK(RightLowerArm, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavR/shoulderR/elbowR");
			if (ikfk != null)
			{
				ikfk.GroupID = IKFKBlend.IKFKType.ArmR;
				ikfk.Init();
			...
			ikfk = OffsetIKFK(ClavL, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavL");
			if (ikfk != null)
			{
				ikfk.GroupID = IKFKBlend.IKFKType.ArmL;
				ikfk.Init();
			}
			ikfk = OffsetIKFK(ClavR, globalControl, "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavR");
			if (ikfk != null)
			{
				ikfk.GroupID = IKFKBlend.IKFKType.ArmR;
				ikfk.Init();
			...
			if (rigFingers)
			{
				string handLString = "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavL/shoulderL/elbowL/handL";
				string handRString = "Spine_01/Spine_02/Spine_03/Spine_04/Spine_05/clavR/shoulderR/elbowR/handR";
		...
		public static void AutoRig(GlobalControl globalControl = null)
		{
			...
			foreach (Guides guide in guides)
			{
				...
				MakeSpine(_hipPoint, _chestPoint, _footLPoint);

				MakeLimb(_thighLPoint, _footLPoint, _kneeLPoint, GameObject.Find("Spine_01"), "legL", "thighL", "kneeL", "footL", true);

				MakeLimb(_thighRPoint, _footRPoint, _kneeRPoint, GameObject.Find("Spine_01"), "legR", "thighR", "kneeR", "footR", true);

				MakeClav(GameObject.Find("Spine_05"), "clavL");
				GameObject clavL = GameObject.Find("clavL");
				MakeLimb(_armLPoint, _handLPoint, _elbowLPoint, clavL, "armL", "shoulderL", "elbowL", "handL", false);


				MakeClav(GameObject.Find("Spine_05"), "clavR");
				GameObject clavR = GameObject.Find("clavR");
				MakeLimb(_armRPoint, _handRPoint, _elbowRPoint, clavR, "armR", "shoulderR", "elbowR", "handR", false);
				...
				MakeHead(_headPoint, _chestPoint, _neckPoint, headTop);

				GameObject[] handL = new GameObject[2] { GameObject.Find("handL"), GameObject.Find("handL_CTRL") };
				GameObject[] handR = new GameObject[2] { GameObject.Find("handR"), GameObject.Find("handR_CTRL") };
				...
				if (rigFingers)
				{
					...
					DestroyImmediate(GameObject.Find("handLEnd"));
					DestroyImmediate(GameObject.Find("handREnd"));
					...
					MakeHandDriver(GameObject.Find("handL_CTRL"), fingerBones);
					...
					MakeHandDriver(GameObject.Find("handR_CTRL"), fingerBones);
		...
		static void MakeClav(GameObject parentTo, string boneName)
		{
			...
			BoneCreation.CreateBoneTool();
			BoneCreation.BoneCreationMode(parentTo.transform.position , new Ray(), true);
			BoneCreation.BoneFinishCreation();
			GameObject clav = GameObject.Find("bone_1");
			clav.name = boneName;			

		}
		static void MakeLimb(Vector3 _thighLPoint, Vector3 _footLPoint, Vector3 _kneePoint, GameObject parentTo, string controlName, string controlName3, string controlName2, string controlName1, bool flip = false)
		{
		...
		static void MakeSpine(Vector3 _hipPoint, Vector3 _chestPoint, Vector3 GroundPos)
		{
			//Spine
		...
		static void MakeHead(Vector3 _headPoint, Vector3 _chestPoint, Vector3 _neckPoint, Vector3 _headTop)
		{
